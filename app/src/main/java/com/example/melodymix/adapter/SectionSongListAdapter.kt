...
import com.example.melodymix.databinding.SectionSongRecyclerRowBinding
...
class SectionSongListAdapter(private val songIdList: List<String>):
    ...
    class MyViewHolder(private val binding: SectionSongRecyclerRowBinding):RecyclerView.ViewHolder(binding.root)
    {
        //        bind data with view
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding=SectionSongRecyclerRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
